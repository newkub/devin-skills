...
- ถ้าผู้ใช้ขอรันอะไรจริง ให้ confirm ว่าจะเปลี่ยน workflow เป็น `/review-delivery` หรือ `/run-dev`
...
- ถ้าต้องการ scan DX patterns จริง ให้ใช้ `/review-delivery`
- ถ้าต้องการ scan file structure ให้ใช้ `/analyze-code-structure`
- ถ้าต้องการ scan naming ให้ใช้ `/review-code-quality`
