...
- ถ้าผู้ใช้ขอรันอะไรจริง ให้ confirm ว่าจะเปลี่ยน workflow เป็น `/review-codebase-everything` หรือ `/run-dev`
...
- ถ้าต้องการ scan DX patterns จริง ให้ใช้ `/review-codebase-everything`
- ถ้าต้องการ scan file structure ให้ใช้ `/check-code-structure`
- ถ้าต้องการ scan naming ให้ใช้ `/review-codebase-everything`
