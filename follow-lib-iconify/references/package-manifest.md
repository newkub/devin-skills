...
| `@iconify/tailwind` | `npm` | `1.2.0` | Tailwind CSS v3 plugin (dynamic icon classes) |
| `@iconify/tailwind4` | `npm` | `1.2.3` | Tailwind CSS v4 plugin |
...
- Version pinned in SKILL.md: `@iconify/react@6.0.2`, `@iconify/vue@5.0.1`, `iconify-icon@3.0.2`, `@iconify/tailwind@1.2.0`, `@iconify/tailwind4@1.2.3`
