---
name: template-workflows-report
description: Template สำหรับสร้าง report-* workflows ที่รวบรวมข้อมูลและนำเสนอ
---

## Goal

Template สำหรับสร้าง `report-*` workflows ที่รวบรวมข้อมูล วิเคราะห์ และนำเสนอในรูปแบบที่อ่านง่าย

## Scope

ใช้สำหรับ workflows ที่ report เช่น `report-health`, `report-status`, `report-todo`, `report-features`, `report-bundle`
...
- ถ้า report พบ issues → แนะนำ workflow ที่เหมาะสม
...
---
title: Report Health
description: วิเคราะห์สุขภาพโปรเจกต์พร้อม health score และ action items
...
## Goal
วิเคราะห์สุขภาพโปรเจกต์และสร้าง report

## Scope
ใช้สำหรับ health report ในทุก workspace
...
1. ทำ `/scan-codebase`, อ่าน configs, อ่าน manifests

### 2. Analyze
วิเคราะห์

> Goal: เข้าใจ patterns และ insights
...
2. สรุป key findings ด้านบน

### 4. Present
นำเสนอ

> Goal: ผู้ใช้ได้ report พร้อมใช้
...
### 1. Clarity
- สรุป key findings ด้านบน

### 2. Accuracy
- ข้อมูลต้องถูกต้องและทันสมัย

## Expected Outcome
- Health report พร้อม score และ action items
```
