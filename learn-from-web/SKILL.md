...
1. ตรวจ context การเรียก: ถ้าถูกเรียกจาก `/follow-create-devin-global-skills` หรือ skill ที่มี dependencies → ต้องเขียน reference files จริง ไม่ใช่แค่ research
...
8. ถ้าเขียน reference ไม่สำเร็จ → stop และ report ไม่ผ่านการ validate ของ `/follow-create-devin-global-skills`
