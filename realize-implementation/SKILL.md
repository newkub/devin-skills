...
1. ทำ `/refactor`, `/update-reference`, `/review-codebase`, `/improve-type-safety`, `/review-codebase` — refactor ครบวงจร, อัปเดท references, เพิ่ม type safety, config optimization
