...
2. ทำ `/update-review-codebase-cli-and-run` เพื่อตรวจ naming และ structure
...
1. ทำ `/update-review-codebase-cli-and-run` เพื่อวิเคราะห์ coverage gaps และบรรลุ 100%
...
- Coverage verification และ 100% enforcement อยู่ใน `/update-review-codebase-cli-and-run` และ `/run-test-coverage`
