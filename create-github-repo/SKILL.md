...
1. ทำตาม `/git-commit-and-push-and-resolve-cicd` เพื่อ commit และ push การเปลี่ยนแปลง
2. ถ้า `git-commit-and-push-and-resolve-cicd` ล้มเหลว → ตรวจ `git status`, `git log`, แล้ว retry สูงสุด 1 ครั้ง
...
- ถ้าไม่มี commit เลย ให้ `git-commit-and-push-and-resolve-cicd` จัดการ commit ครั้งแรก
