---
name: improve-isolation
description: ปรับปรุง isolation ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง isolation ของ project ให้ดีขึ้น

## Scope

ใช้กับ isolation ใน project หรือ workspace ที่ต้องการปรับปรุง
