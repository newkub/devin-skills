---
name: review-images
description: Review image format, responsive images, lazy loading, CDN, compression, EXIF stripping, thumbnail...
allowed-tools:
  - read
  - edit
  - grep
...
Review image optimization ครอบคลุม format, responsive, lazy loading, CDN, compression พร้อม review score
