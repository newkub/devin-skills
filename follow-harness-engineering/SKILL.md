...
5. ตรวจสอบ Observability: logging, tracing, metrics, execution traces ทำ `/review-delivery`
...
5. ทำ `/review-delivery` สำหรับ comprehensive observability improvements
