...
5. ตรวจสอบ Observability: logging, tracing, metrics, execution traces ทำ `/review-codebase-everything`
...
5. ทำ `/review-codebase-everything` สำหรับ comprehensive observability improvements
