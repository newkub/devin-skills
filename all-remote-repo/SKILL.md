---
name: all-remote-repo
description: รายการ remote repositories บน GitHub ที่ user เป็นเจ้าของ ไม่รวม fork
related:
  - list-github-repo
...
รายการ remote repositories ทั้งหมดบน GitHub ที่ผู้ใช้เป็นเจ้าของ โดยกรอง fork และ archived ออก
...
2. แปลง `updatedAt` เป็น `YYYY-MM-DD`
