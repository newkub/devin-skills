...
description: ปรับปรุง serialization ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง serialization ของ project ให้ดีขึ้น

## Scope

ใช้กับ serialization ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- serialization ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล