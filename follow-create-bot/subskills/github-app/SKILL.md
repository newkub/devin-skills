---
name: follow-create-bot-github-app
description: สร้าง GitHub App จริง — manifest, JWT auth, installation, webhooks
...
ใช้สำหรับสร้าง GitHub App จาก scratch ด้วย TypeScript/Bun — ครอบคลุม app registration, JWT auth, installation tokens, webhook handlers และ event subscriptions — ถ้าต้องการเพียง bot ง่ายๆ ที่ทำงานผ่าน Actions ให้ใช้ `subskills/github/SKILL.md`
