...
1. ทำ `/report` แสดง: Good Commit, Bad Commit, First Bad Commit, Author, Date
...
4. ทำ `/update-tests` เพื่อสร้าง regression test สำหรับปัญหาที่พบ
