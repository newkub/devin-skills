...
description: ปรับปรุง garbage-collection ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง garbage-collection ของ project ให้ดีขึ้น

## Scope

ใช้กับ garbage-collection ใน project หรือ workspace ที่ต้องการปรับปรุง
...
### 2. Improve
> Goal: ปรับปรุง garbage-collection
...
## Expected Outcome
- garbage-collection ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล