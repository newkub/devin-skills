...
|----------|-----|-------------|
| Official Website | https://nodejs.org | Node.js official website |
| Documentation | https://nodejs.org/docs | Official documentation |
| GitHub | https://github.com/nodejs/node | Source code |
| Downloads | https://nodejs.org/download | Download releases |
| Foundation | https://openjsf.org | OpenJS Foundation |
...
| http | https://nodejs.org/api/http.html | HTTP/HTTPS |
| path | https://nodejs.org/api/path.html | Path utilities |
| events | https://nodejs.org/api/events.html | Event emitter |
| stream | https://nodejs.org/api/stream.html | Streams |
...
| Discord | https://discord.gg/nodejs | Community chat |

## Tools

| Tool | URL | Description |
|------|-----|-------------|
| Node.js Version Manager | https://github.com/nvm-sh/nvm | Version manager |
| Node.js Version Manager (Windows) | https://github.com/coreybutler/nvm-windows | Windows version manager |
| Volta | https://volta.sh | Fast version manager |
| asdf | https://asdf-vm.com | Extensible version manager |

## Release Information

| Resource | URL | Description |
|----------|-----|-------------|
| Releases | https://nodejs.org/en/about/releases | Release schedule |
| Changelog | https://github.com/nodejs/node/blob/main/CHANGELOG.md | Version history |
| LTS Schedule | https://nodejs.org/en/about/releases | LTS timeline |
