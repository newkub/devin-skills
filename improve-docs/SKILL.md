---
name: improve-docs
description: ปรับปรุง docs ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง docs ของ project ให้ดีขึ้น

## Scope

ใช้กับ docs ใน project หรือ workspace ที่ต้องการปรับปรุง
