...
description: ปรับ log quality ทั้ง levels, structure, context และ redaction ของ sensitive data
...
- Action-oriented: แก้ logging จริง — สัมพันธ์กับ `/improve-observability` (metrics/tracing)
