...
- Read-only ต่อข้อมูลจริง: ตรวจสอบอย่างเดียว — แก้ไขผ่าน section `## Fix` ของ `/review-migration`
...
- ไม่แก้ข้อมูลระหว่าง verify — mismatch ให้รายงานแล้วทำ section `## Fix` ของ `/review-migration`
