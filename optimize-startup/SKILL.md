...
description: ปรับปรุง startup ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง startup ของ project ให้ดีขึ้น

## Scope

ใช้กับ startup ใน project หรือ workspace ที่ต้องการปรับปรุง
