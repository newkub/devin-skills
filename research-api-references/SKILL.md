...
ค้นหา API references ที่น่าเชื่อถือสำหรับ API, library, หรือ tool ที่ระบุ สรุปเป็นรายการพร้อมแหล่งอ้างอิง

## Scope

ใช้เมื่อต้องการหา references ของ API/library/tool ใหม่หรือตรวจสอบ API ที่มีอยู่ โดยเน้นการค้นหาจากหลายแหล่งด้วย /deep-research
...
3. ระบุประเภทข้อมูลที่ต้องการ (official docs, examples, tutorials, benchmarks)
...
> Goal: นำเสนอผลลัพธ์ในรูปแบบที่อ่านง่าย

1. ใช้ markdown table หรือ numbered list
2. ระบุ URL, คำอธิบายสั้น, แหล่งที่มา, และปี/version
