---
name: improve-recoverability
description: ปรับปรุง recoverability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง recoverability ของ project ให้ดีขึ้น

## Scope

ใช้กับ recoverability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- recoverability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล