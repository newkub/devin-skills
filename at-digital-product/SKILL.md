---
name: at-digital-product
project-root: D:/saas/digital-product
description: แก้ไข files ใน project digital-product
---

## Goal

แก้ไข files ใน project `D:/saas/digital-product` อย่างปลอดภัย มีขอบเขตชัดเจน และ validate

## Scope

ใช้เมื่องานต้องแก้ไข source code, config, docs ใน `digital-product`
...
1. ตรวจสอบ `project-root: D:/saas/digital-product`
2. ใช้ `workdir = D:/saas/digital-product` สำหรับทุก command
...
- ใช้ `workdir = D:/saas/digital-product` เสมอ
