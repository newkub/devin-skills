...
description: ปรับปรุง connection ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง connection ของ project ให้ดีขึ้น

## Scope

ใช้กับ connection ใน project หรือ workspace ที่ต้องการปรับปรุง
