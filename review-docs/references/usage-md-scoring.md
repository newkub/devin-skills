...
คำนวณ review score สำหรับ `USAGE.md` review
...
- Score < 70 → แนะนำให้เรียก `update-docs usage-md` ก่อนดำเนินการ
...
|--------|-------------|------------------|
| Review Coverage Ratio | % ของ USAGE.md sections, examples, commands, headings และ project references ใน scope ที่ review ครบ | reviewed / total × 100 |
