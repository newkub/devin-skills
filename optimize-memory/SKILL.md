...
description: ปรับปรุง memory ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง memory ของ project ให้ดีขึ้น

## Scope

ใช้กับ memory ใน project หรือ workspace ที่ต้องการปรับปรุง
