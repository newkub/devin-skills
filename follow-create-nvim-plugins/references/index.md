# Create Neovim Plugins References Index

| File | Responsibility |
|---|---|
| [lazy-nvim-setup.md](lazy-nvim-setup.md) | Bootstrap and setup lazy.nvim plugin manager with leader keys and configuration |
