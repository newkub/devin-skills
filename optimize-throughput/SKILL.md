...
description: ปรับปรุง throughput ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง throughput ของ project ให้ดีขึ้น

## Scope

ใช้กับ throughput ใน project หรือ workspace ที่ต้องการปรับปรุง
