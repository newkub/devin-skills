---
name: at-wrikka-com
project-root: D:/newkub/products/wrikka-com
description: แก้ไข files ใน project wrikka-com
---

## Goal

แก้ไข files ใน project `D:/newkub/products/wrikka-com` อย่างปลอดภัย มีขอบเขตชัดเจน และ validate

## Scope

ใช้เมื่องานต้องแก้ไข source code, config, docs ใน `wrikka-com`
...
1. ตรวจสอบ `project-root: D:/newkub/products/wrikka-com`
2. ใช้ `workdir = D:/newkub/products/wrikka-com` สำหรับทุก command
...
- ใช้ `workdir = D:/newkub/products/wrikka-com` เสมอ
