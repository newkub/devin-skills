...
4. ถ้าพบ gaps ใน coverage → ทำ `/review-coverage`
...
4. ถ้า workflow มี > 5 steps หรือ high-risk actions → parallel เพิ่ม: `/improve-context-rot` ∥ `/follow-harness-engineering` ∥ `/review-coverage`
