...
- ทำ `/update-review-codebase-cli-and-run` เพื่อตรวจสอบ architecture issues
...
- ทำ `/refactor-workspace` เพื่อปรับปรุงโครงสร้างโค้ดใน workspace
...
- ทำ `/update-review-codebase-cli-and-run` เพื่อตรวจสอบ architecture consistency
