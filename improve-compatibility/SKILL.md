---
name: improve-compatibility
description: ปรับปรุง compatibility ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง compatibility ของ project ให้ดีขึ้น

## Scope

ใช้กับ compatibility ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- compatibility ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล