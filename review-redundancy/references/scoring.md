...
คำนวณ review score สำหรับ redundancy audit
...
- Score < 70 → แนะนำ merge/split/refine ก่อนดำเนินการ
...
|--------|-------------|------------------|
| Review Coverage Ratio | % ของ skills, descriptions, scopes, content blocks และ related references ใน scope ที่ review ครบ | reviewed / total × 100 |
