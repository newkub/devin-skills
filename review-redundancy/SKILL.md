...
1. ถ้ามี merge candidates ที่เหมาะสม → ทำ `/idea-merge`
2. ถ้ามี rename candidates ที่เหมาะสม → ทำ `/batch-rename-files`
3. ถ้าต้อง remove หรือ merge ขอ user confirm เสมอ
...
- ถ้ามี merge candidates จะแนะนำ `/idea-merge`
