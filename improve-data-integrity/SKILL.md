...
description: ปรับปรุง data-integrity ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง data-integrity ของ project ให้ดีขึ้น

## Scope

ใช้กับ data-integrity ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- data-integrity ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล