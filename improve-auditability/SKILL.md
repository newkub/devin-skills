---
name: improve-auditability
description: ปรับปรุง auditability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง auditability ของ project ให้ดีขึ้น

## Scope

ใช้กับ auditability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- auditability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล