...
ไม่รวม UX copy (ใช้ `/review-frontend`), content coverage (ใช้ `/review-delivery`), SEO (ใช้ `/review-platform`), code quality (ใช้ `/review-quality`) — อยู่ภายใต้ `/review-codebase-everything` เมื่อ review delivery ทั้งหมด
