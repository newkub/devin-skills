...
1. ทำ `/read-related-skills` เพื่ออ่าน skills ที่เกี่ยวข้องและทำความเข้าใจ dependency graph
2. สแกน skills directory หา: ไฟล์เกิน 250 บรรทัด, หลาย responsibility, scope ซ้อนทับ, เนื้อหาซ้ำซ้อน
3. อ่าน `SKILL.md` ของ skills ที่น่าสงสัยเพื่อยืนยันปัญหา
4. บันทึก issues พร้อม priority: High (redundancy มาก, ไฟล์ใหญ่, broken structure), Medium, Low
...
> Goal: ย้าย skills ไปยังตำแหน่งที่เหมาะสมตาม prefix และ responsibility

1. ทำ `/relocation` เพื่อย้าย skills ไปยังตำแหน่งที่เหมาะสมตาม prefix (`follow-lang-*`, `follow-framework-*`, `follow-service-*`, `follow-lib-*`, `follow-tool-*`, `follow-create-*`, `follow-*`)
2. ตรวจว่าทุก skill อยู่ในตำแหน่งที่สอดคล้องกับ prefix ตามมาตรฐานใน `/follow-write-devin-skills`
3. ถ้ามี skill ที่ prefix ไม่ตรงกับ responsibility → เปลี่ยน prefix และย้าย
4. บันทึกการย้ายทุกครั้งพร้อมเหตุผล

### 5. Update References And Sort
