...
description: ปรับปรุง storage ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง storage ของ project ให้ดีขึ้น

## Scope

ใช้กับ storage ใน project หรือ workspace ที่ต้องการปรับปรุง
