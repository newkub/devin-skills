...
- ทำ `/report-markdown-table`, `/report-markdown-file-structure` ถ้าเกี่ยวกับ files. ใช้ headings, lists, tables. สรุป key findings ด้านบน. นำเสนอ report. ถ้า interactive → ทำ `/report-in-html` หรือ `/visualize-in-web`
