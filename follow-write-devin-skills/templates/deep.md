...
- ทำ `/report-markdown-table`. จัดลำดับตาม impact และ effort. ระบุ immediate และ long-term actions. ทำ `/suggest-next-action`. วิเคราะห์ให้ลึก. ถ้าไม่แน่ใจ → ค้นคว้าเพิ่ม. ระบุ assumptions. ทุก finding ต้องมี evidence. ถ้าเป็น opinion → ระบุ. ครบทุก dimensions. ถ้า dimension ไม่มี findings → ระบุ "no issues". ไม่ข้าม dimensions
