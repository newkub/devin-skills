...
- สร้างไอเดียพร้อม continuous numbering (ไม่ต่อจากเดิมถ้ามีอยู่แล้ว). ระบุ scope (quick win, short-term, long-term), impact, effort. ทำ `/report-markdown-table`. คอลัมน์: number, idea, category, impact, effort, scope. จัดลำดับตาม impact/effort ratio
