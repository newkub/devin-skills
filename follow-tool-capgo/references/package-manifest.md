...
|---------|----------|--------|-------|
| `@capgo/cli` | `npm` | `8.51.0` (2026-09-12) | Capgo CLI for OTA bundle upload/manage |
| `@capgo/capacitor-native-biometric` | `npm` | `8.6.8` (2026-09-12) | Biometric auth plugin (Keychain/Keystore) |
