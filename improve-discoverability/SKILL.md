...
description: ปรับปรุง discoverability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง discoverability ของ project ให้ดีขึ้น

## Scope

ใช้กับ discoverability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- discoverability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล