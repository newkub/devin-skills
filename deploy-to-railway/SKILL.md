...
Latest: `@railway/cli@5.53.0` (verified 2026-09-12) — install script `railway.com/install.sh` หรือ npm global
...
5. ทำ `/watch-browser fix` ด้วย deployment URL ถ้ามี domain
