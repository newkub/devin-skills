...
description: แก้ findings จาก review-compliance ครอบคลุม licenses, privacy, audit และ data handling
...
1. flag/mask sensitive data ใน logs (PII, tokens, passwords) — ทำ `/improve-logging` ร่วม
