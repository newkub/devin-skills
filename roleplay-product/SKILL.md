---
name: roleplay-product
description: Roleplay product personas — product-manager, product-designer, business-analyst, product-analyst
...
ใช้เมื่อต้องการมุมมอง product — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-product <role>`
...
| Role | Focus | Subskill |
|------|-------|----------|
| product-manager | feature completeness, prioritization, user value | `subskills/product-manager/SKILL.md` |
| product-designer | UX consistency, flows, design-dev fidelity | `subskills/product-designer/SKILL.md` |
| business-analyst | requirements traceability, business rules, edge cases | `subskills/business-analyst/SKILL.md` |
| product-analyst | instrumentation, funnels, feature flags, metrics | `subskills/product-analyst/SKILL.md` |
