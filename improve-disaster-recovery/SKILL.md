---
name: improve-disaster-recovery
description: ปรับปรุง disaster-recovery ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง disaster-recovery ของ project ให้ดีขึ้น

## Scope

ใช้กับ disaster-recovery ใน project หรือ workspace ที่ต้องการปรับปรุง
...
### 2. Improve
> Goal: ปรับปรุง disaster-recovery
...
## Expected Outcome
- disaster-recovery ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล