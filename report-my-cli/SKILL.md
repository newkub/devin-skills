...
1. ทำ `/follow-my-cli` เพื่อเช็ค tools ที่ติดตั้ง
...
2. ถ้าข้อมูลไม่พอ → ทำ `/follow-my-cli` อีกรอบหรือ `/learn-from-cli` เพิ่มเติม
...
- ไม่ duplicate ข้อมูลจาก `/follow-my-cli` หรือ `/learn-from-cli`
