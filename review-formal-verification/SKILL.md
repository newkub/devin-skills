...
- ถ้า issue ซ้อนทับกับ `/review-types` (type system design) → อ้างอิงแทน ไม่ duplicate
- ถ้า issue ซ้อนทับกับ `/review-test` (test coverage/quality) → อ้างอิงแทน ไม่ duplicate
