...
- ถ้าผู้ใช้ขอรันอะไรจริง ให้ confirm ว่าจะเปลี่ยน workflow เป็น `/run-audit` หรือ `/update-review-codebase-cli-and-run`
...
- ถ้าต้องการ scan security patterns จริง ให้ใช้ `/update-review-codebase-cli-and-run`
- ถ้าต้องการ run security audit จริง ให้ใช้ `/run-audit`
- ถ้าต้องการเฉพาะ browser security ให้ใช้ `/update-review-codebase-cli-and-run`
