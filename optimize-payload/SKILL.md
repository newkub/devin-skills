---
name: optimize-payload
description: ปรับปรุง payload ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง payload ของ project ให้ดีขึ้น

## Scope

ใช้กับ payload ใน project หรือ workspace ที่ต้องการปรับปรุง
