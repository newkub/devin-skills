...
debuggability review สำหรับ: logging statements, error messages, naming conventions, code complexity, nesting levels, self-documenting code — ไม่รวมการ fix (ใช้ `/review-debugging` สำหรับ fix)
...
- รายละเอียดการ fix อยู่ใน `/review-debugging` แล้ว
