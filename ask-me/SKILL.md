...
3. ระบุตัวเลือกที่แนะนำโดยเพิ่ม emoji นำหน้า `label` (เช่น `✨ ทำ /deep-plan ต่อ`) พร้อมข้อความแนะนำ และอธิบายเหตุผลใน `description`
...
- ระบุตัวเลือกแนะนำด้วย emoji นำหน้า `label` (เช่น `✨`, `⭐`, `👍`) พร้อมข้อความแนะนำ เช่น `✨ ทำ /deep-plan ต่อ`
