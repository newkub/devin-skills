...
description: ปรับปรุง pipeline ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง pipeline ของ project ให้ดีขึ้น

## Scope

ใช้กับ pipeline ใน project หรือ workspace ที่ต้องการปรับปรุง
