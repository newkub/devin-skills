...
4. parallel: ทำ `/list-system-env` เพื่อดู paths หลัก ∥ ทำ `/follow-my-cli` เพื่อดู CLI tools ที่ติดตั้ง
...
2. ทำ `/report-format-file-structure` สำหรับ top 10 directories ที่ใหญ่ที่สุด
3. สรุป:
   - จำนวน candidates
