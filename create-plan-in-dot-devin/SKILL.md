...
1. ถ้าผู้ใช้หรืองานอื่นแจ้งว่าดำเนินการตามแผนครบทุกขั้นตอนแล้ว → อัปเดต `status` เป็น `completed`
2. ลบไฟล์ `.devin/plan/<title>-<time>.md` ที่สร้างขึ้น
...
- ถ้าดำเนินการตามแผนจนครบถ้วนแล้ว ให้ลบไฟล์แผน `.devin/plan/<title>-<time>.md` ที่สร้างขึ้น
