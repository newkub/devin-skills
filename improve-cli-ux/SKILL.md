---
name: improve-cli-ux
description: ปรับ CLI experience ทั้ง help text, output format, flags, prompts และ error messages
...
3. แก้ errors — messages ที่ actionable, exit codes ถูก, ทำ `/improve-error-messages` ร่วม
