...
description: ปรับปรุง rendering ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง rendering ของ project ให้ดีขึ้น

## Scope

ใช้กับ rendering ใน project หรือ workspace ที่ต้องการปรับปรุง
