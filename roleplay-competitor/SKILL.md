...
- ถ้าผู้ใช้ขอรันอะไรจริง ให้ confirm ว่าจะเปลี่ยน workflow เป็น `/bench-competitors` หรือ `/review-codebase-everythink`
...
- ถ้าต้องการ review ทุกมิติ ให้ใช้ `/review-codebase-everythink`
