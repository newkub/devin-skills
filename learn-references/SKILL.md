...
ใช้เมื่อ skill มี `references/` directory หรือต้องการดึงความรู้จาก reference materials เพื่อเขียน guides, examples, หรือ documentation ครอบคลุม ไม่ใช่สร้าง references (ใช้ `/learn-web` สำหรับสร้าง)
...
4. ถ้าไม่มี `references/` → ทำ `/learn-web` สร้างก่อน แล้วกลับมาทำขั้นตอนนี้
...
2. ทำ `/learn-web` จาก official docs เพื่อ cross-check ข้อมูลสำคัญ
...
5. ทำ `/report` สรุป gaps: ประเภท, สิ่งที่ขาด, priority, impact
...
- ใช้ `/learn-web` จาก official docs เพื่อ cross-check
