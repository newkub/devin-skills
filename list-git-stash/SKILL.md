...
ใช้สำหรับดู stashes ใน local repository — ไม่รวมการ create, apply, drop (ใช้ `/follow-tool-git` สำหรับ stash operations)
...
- ไม่ create, apply, drop หรือ clear stash — ใช้ `/follow-tool-git` สำหรับ stash operations
...
- Stash operations อยู่ใน `/follow-tool-git` แล้ว
