...
ใช้กับ frontend code (React, Vue, Solid, Svelte, Angular, vanilla JS) — ไม่รวม UX/UI design ลึกหรือ backend (ใช้ `/review-uxui`, `/review-backend` แทน)
...
1. ทำ `/review-frontend` สำหรับ performance findings
...
4. ตรวจ accessibility ด้วย `/review-accessibility` ถ้ามี findings
