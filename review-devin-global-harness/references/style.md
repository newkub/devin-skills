...
- ใช้ backticks สำหรับ `paths` (เช่น `SKILL.md`, `references/website.md`)
- ใช้ backticks สำหรับ `skill-name` (เช่น `update-devin-global-skills`, `review-devin-global-harness`)
