---
name: roleplay-engineering
description: Roleplay engineering personas — architect, frontend, backend, fullstack, database, devops
...
ใช้เมื่อต้องการมุมมอง engineering — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-engineering <role>`
...
| Role | Focus | Subskill |
|------|-------|----------|
| software-architect | modularity, boundaries, coupling, resilience | `subskills/software-architect/SKILL.md` |
| frontend-developer | component structure, state, rendering, a11y | `subskills/frontend-developer/SKILL.md` |
| backend-developer | API/service layer, data flow, error handling | `subskills/backend-developer/SKILL.md` |
| fullstack-developer | e2e wiring, FE↔BE contracts, cross-layer duplication | `subskills/fullstack-developer/SKILL.md` |
| database-engineer | schema, indexes, queries, migrations | `subskills/database-engineer/SKILL.md` |
| devops-engineer | CI/CD, deploy config, env management, observability | `subskills/devops-engineer/SKILL.md` |
