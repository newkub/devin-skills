...
| File | Responsibility |
|------|----------------|
| vercel-overview.md | Vercel platform overview: installation, login, deploy, Git integration, preview deployments, edge functions, image optimization, monitoring |
