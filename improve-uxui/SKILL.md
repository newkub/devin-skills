...
ใช้กับ web apps, components, pages ทีต้องการ capture จริง วิเคราะห์ UX/UI ผ่าน stakeholder review และ implement การปรับปรุง
...
2. ทำ `/review-by-stakeholder` เพื่อขอ feedback
...
3. ทำ `/review-by-stakeholder` อีกครั้งเพื่อยื่นยัน improvements
