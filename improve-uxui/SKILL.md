---
name: improve-uxui
description: ปรับปรุง uxui ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง uxui ของ project ให้ดีขึ้น

## Scope

ใช้กับ uxui ใน project หรือ workspace ที่ต้องการปรับปรุง
