...
ใช้สำหรับ review observability setup — อยู่ภายใต้ `/review-infrastructure` เมื่อ review infrastructure ทั้งหมด — deployment, CI/CD, disaster recovery อยู่ใน `/review-infrastructure`
