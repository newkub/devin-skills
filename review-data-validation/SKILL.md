...
Review data validation ครอบคลุม schema validation, input/output validation, data contracts, transformation safety พร้อม review score
...
> Goal: ครอบคลุมทุก validation dimension พร้อม review score
