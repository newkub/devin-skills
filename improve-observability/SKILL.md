...
description: ปรับปรุง observability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง observability ของ project ให้ดีขึ้น

## Scope

ใช้กับ observability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- observability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล