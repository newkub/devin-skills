---
name: improve-telemetry
description: ปรับปรุง telemetry ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง telemetry ของ project ให้ดีขึ้น

## Scope

ใช้กับ telemetry ใน project หรือ workspace ที่ต้องการปรับปรุง
