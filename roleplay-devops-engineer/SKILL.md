...
- ถ้าผู้ใช้ขอรันอะไรจริง ให้ confirm ว่าจะเปลี่ยน workflow เป็น `/review-codebase-everythink` หรือ `/run-build`
...
- ถ้าต้องการ scan deployment จริง ให้ใช้ `/review-codebase-everythink`
- ถ้าต้องการ scan CI/CD จริง ให้ใช้ `/review-codebase-everythink`
- ถ้าต้องการ scan monitoring จริง ให้ใช้ `/review-codebase-everythink`
