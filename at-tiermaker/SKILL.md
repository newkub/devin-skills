---
name: at-tiermaker
project-root: D:/newkub/web-side-projects/tiermaker
description: แก้ไข files ใน project tiermaker
---

## Goal

แก้ไข files ใน project `D:/newkub/web-side-projects/tiermaker` อย่างปลอดภัย มีขอบเขตชัดเจน และ validate

## Scope

ใช้เมื่องานต้องแก้ไข source code, config, docs ใน `tiermaker`
...
1. ตรวจสอบ `project-root: D:/newkub/web-side-projects/tiermaker`
2. ใช้ `workdir = D:/newkub/web-side-projects/tiermaker` สำหรับทุก command
...
- ใช้ `workdir = D:/newkub/web-side-projects/tiermaker` เสมอ
