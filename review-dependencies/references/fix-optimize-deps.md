...
- Boundary: ฝั่ง weight เท่านั้น — outdated/vulnerable/license findings ให้ส่งต่อ `/review-dependencies`
...
- ถ้า dep หนักแต่จำเป็น → ลดผ่าน subpath imports หรือ lazy loading (`/review-quality`)
