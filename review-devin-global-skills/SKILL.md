...
6. ถ้าสร้าง sub-skills ใหม่ → ทำ `/follow-write-devin-skills` สำหรับแต่ละ sub-skill
...
3. ทำ `/report-markdown-table` พร้อม findings: Skill, Category, Severity, Finding, Evidence, Action
