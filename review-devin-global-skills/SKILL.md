...
- `review` — ตรวจ skill package แต่ละตัวตามมาตรฐาน `follow-create-devin-global-skills` (frontmatter, sections, line count, references, template, style, content quality)
...
2. อ่าน `follow-create-devin-global-skills` เพื่อทราบมาตรฐาน
...
6. ถ้าสร้าง sub-skills ใหม่ → ทำ `/follow-create-devin-global-skills` สำหรับแต่ละ sub-skill
