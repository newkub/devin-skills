...
- เขียน/แก้ไข config. ระบุ entry point และ initial setup. ใช้ examples จาก `references/components/` หรือ `examples/`. ทำ `/validate` หรือ `/run-verify`. รัน tests/examples. ทำ `/git-commit` ถ้ามีการเปลี่ยนแปลง
