...
4. ทำ `/follow-create-devin-global-skills` เพื่อสร้าง project-specific workflows
...
- ใช้ `/follow-create-devin-global-skills` สำหรับสร้าง project-specific workflows
