...
description: ปรับปรุง onboarding ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง onboarding ของ project ให้ดีขึ้น

## Scope

ใช้กับ onboarding ใน project หรือ workspace ที่ต้องการปรับปรุง
