...
ตรวจสอบ `tools/review-codebase` CLI ก่อนเรียก `/review-codebase-everythink` เพื่อยืนยันว่า Clean Architecture, analyzer structure, category coverage, CLI interface, และ workspace integration ครบถ้วนและถูกต้อง
...
3. ตรวจว่าทุก analyzer มี `reviewWorkflow` map ไปยัง `/review-codebase-everythink` หรือ references
...
- ถ้าต้องแก้ไข ให้เรียก `/review-codebase-everythink` หลัง review
...
- Score < 70 → แนะนำให้เรียก `/review-codebase-everythink` ก่อนดำเนินการ
