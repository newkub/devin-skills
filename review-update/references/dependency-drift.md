...
- `update-version-to-latest` สำหรับ update ทุก versioned สิ่ง (dependencies, runtimes, tools, config)
- `update-version-to-latest` สำหรับ update dependencies เป็น latest
