...
Review database ครอบคลุม schema design, migration safety, data integrity, query patterns, search พร้อม health score
...
> Goal: ครอบคลุมทุก database dimension พร้อม health score
