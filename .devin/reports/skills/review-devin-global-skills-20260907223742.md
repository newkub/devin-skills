...
| 2 | check-files | frontmatter | Medium | orphan related reference | related: deep-analyze not mentioned in body | check-files\SKILL.md |
| 3 | check-files | style | Medium | uses bold markers ** | 1. **Deep nesting**: ไฟล์หรือโฟลเดอรอยู่ลึกเกิน 5 levels (นับจาก root) | check-files\SKILL.md |
...
| 5 | create-cloudflare | frontmatter | Medium | orphan related reference | related: use-wrangler not mentioned in body | create-cloudflare\SKILL.md |
| 6 | create-github | frontmatter | Medium | orphan related reference | related: use-gh-cli not mentioned in body | create-github\SKILL.md |
...
| 10 | deep-validate | frontmatter | Medium | orphan related reference | related: check-files not mentioned in body | deep-validate\SKILL.md |
| 11 | deep-validate | frontmatter | Medium | orphan related reference | related: check-files not mentioned in body | deep-validate\SKILL.md |
...
| 13 | deep-validate | frontmatter | Medium | orphan related reference | related: check-files not mentioned in body | deep-validate\SKILL.md |
...
| 21 | from-chat-session | frontmatter | Medium | orphan related reference | related: report-table not mentioned in body | from-chat-session\SKILL.md |
| 22 | idea-convert-my-global-cli-to-skills | frontmatter | Medium | orphan related reference | related: download-program not mentioned in body | idea\subskills\convert-my-global-cli-to-skills\SKILL.md |
| 23 | improve | frontmatter | Medium | orphan related reference | related: prioritize not mentioned in body | improve\SKILL.md |
| 24 | learn (web) | frontmatter | Medium | orphan related reference | related: use-mcp not mentioned in body | learn/subskills/web/SKILL.md |
...
| 29 | refactor | frontmatter | Medium | orphan related reference | related: check-files not mentioned in body | refactor\SKILL.md |
...
| 31 | report-codeblock | frontmatter | Medium | orphan related reference | related: report not mentioned in body | report-codeblock\SKILL.md |
| 32 | report-codeblock | frontmatter | Medium | orphan related reference | related: report-table not mentioned in body | report-codeblock\SKILL.md |
| 33 | report-codeblock | frontmatter | Medium | orphan related reference | related: report-numbered not mentioned in body | report-codeblock\SKILL.md |
| 34 | report-codeblock | frontmatter | Medium | orphan related reference | related: report-todo not mentioned in body | report-codeblock\SKILL.md |
| 35 | report-codeblock | frontmatter | Medium | orphan related reference | related: review-writing not mentioned in body | report-codeblock\SKILL.md |
| 36 | report-numbered | frontmatter | Medium | orphan related reference | related: report-progress not mentioned in body | report-numbered\SKILL.md |
| 37 | report-table | frontmatter | Medium | orphan related reference | related: report not mentioned in body | report-table\SKILL.md |
| 38 | report-table | frontmatter | Medium | orphan related reference | related: report-numbered not mentioned in body | report-table\SKILL.md |
| 39 | report-table | frontmatter | Medium | orphan related reference | related: report-progress not mentioned in body | report-table\SKILL.md |
...
| 41 | report-todo | frontmatter | Medium | orphan related reference | related: report-table not mentioned in body | report-todo\SKILL.md |
| 42 | report-usage | frontmatter | Medium | orphan related reference | related: update-docs usage-md not mentioned in body | report-usage\SKILL.md |
| 43 | resolve-errors-cicd | frontmatter | Medium | orphan related reference | related: use-gh-cli not mentioned in body | resolve-errors\subskills\cicd\SKILL.md |
| 44 | resolve-errors-cloudflare-worker | frontmatter | Medium | orphan related reference | related: use-wrangler not mentioned in body | resolve-errors\subskills\cloudflare-worker\SKILL.md |
...
| 54 | update-docs agents-md | references | Medium | slash reference to unknown skill | /update-devin-global | update-docs agents-md\SKILL.md |
...
| 60 | update-devin-global-skills | frontmatter | Medium | orphan related reference | related: check-repo-hygiene not mentioned in body | update-devin-global-skills\SKILL.md |
...
| 71 | use-gh-cli | frontmatter | Medium | orphan related reference | related: create-github not mentioned in body | use-gh-cli\SKILL.md |
...
| 73 | use-gh-cli | frontmatter | Medium | orphan related reference | related: resolve-errors not mentioned in body | use-gh-cli\SKILL.md |
...
| 82 | watch-browser-fix | frontmatter | Medium | orphan related reference | related: use-agent-browser not mentioned in body | watch-browser-fix\SKILL.md |
...
| 86 | idea-merge | frontmatter | Low | description over 100 chars | length: 115 | idea\subskills\merge\SKILL.md |
| 87 | idea-new-devin-global-skills | frontmatter | Low | description over 100 chars | length: 112 | idea\subskills\new-devin-global-skills\SKILL.md |
