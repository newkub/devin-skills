# follow-lang-typescript References Index

| File | Responsibility |
|---|---|
| [typescript-type-system.md](typescript-type-system.md) | Type system: generics, conditional types, mapped types, inference |
| [typescript-modern-features.md](typescript-modern-features.md) | Modern features: decorators, satisfies, using, const type parameters |
