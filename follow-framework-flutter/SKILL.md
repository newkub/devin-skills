...
5. ดูรายละเอียดโครงสร้างใน Clean Architecture docs
...
4. ดูตัวอย่าง GoRouter ใน GoRouter official docs
...
4. ดูตัวอย่าง `Failure` และ `Either` ใน fpdart official docs
...
5. ดูตัวอย่าง unit test ใน Flutter testing docs
