---
name: resolve-errors-cloudflare-worker
...
ดูเพิ่มเติม: /list-cloudflare-projects, /resolve-errors cloudflare, `references/list-fails.md`
...
> Goal: แนะนำต่อ
1. ทำ `/suggest-next-action` เพื่อแนะนำ redeploy, check logs หรือ `/resolve-errors cloudflare`
