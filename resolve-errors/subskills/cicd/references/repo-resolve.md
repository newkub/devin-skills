...
1. ทำ `/resolve-errors github-actions --repo <owner/repo>`
...
2. ทำ `/resolve-errors cloudflare-worker --worker <worker-name>` หรือ `/resolve-errors cloudflare --project <project-name>`
