---
name: optimize-event-loop
description: ปรับปรุง event-loop ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง event-loop ของ project ให้ดีขึ้น

## Scope

ใช้กับ event-loop ใน project หรือ workspace ที่ต้องการปรับปรุง
