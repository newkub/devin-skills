---
name: optimize-query
description: ปรับปรุง query ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง query ของ project ให้ดีขึ้น

## Scope

ใช้กับ query ใน project หรือ workspace ที่ต้องการปรับปรุง
