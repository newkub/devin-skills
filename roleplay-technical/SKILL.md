---
name: roleplay-technical
description: Roleplay technical — researcher, code-optimizer, refactoring-specialist, documentation-writer
...
ใช้เมื่อต้องการมุมมอง technical — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-technical <role>`
