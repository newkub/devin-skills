...
| File | Responsibility |
|------|----------------|
| sveltekit-api.md | SvelteKit API reference: $app/stores, $app/state, $app/environment, $app/forms, $app/navigation, $app/server, $app/types, SvelteKit functions (error, redirect, fail, json), exports (load, actions, prerender, entries) |
