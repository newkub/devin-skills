...
3. ตรวจสอบว่ามี binary ที่ `target/release/check-files long-files` (หรือ `.exe` บน Windows)
...
2. รันคำสั่ง `<skill-dir>/target/release/check-files long-files [threshold]`
