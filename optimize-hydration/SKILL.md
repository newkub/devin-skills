---
name: optimize-hydration
description: ปรับปรุง hydration ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง hydration ของ project ให้ดีขึ้น

## Scope

ใช้กับ hydration ใน project หรือ workspace ที่ต้องการปรับปรุง
