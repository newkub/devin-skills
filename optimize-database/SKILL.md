...
description: ปรับปรุง database ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง database ของ project ให้ดีขึ้น

## Scope

ใช้กับ database ใน project หรือ workspace ที่ต้องการปรับปรุง
