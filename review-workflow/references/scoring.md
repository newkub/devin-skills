...
คำนวณ review score สำหรับ workflow review
...
- Score < 70 → แนะนำปรับปรุง workflow ก่อนดำเนินการ
...
|--------|-------------|------------------|
| Review Coverage Ratio | % ของ workflow steps, skills, decisions และ outputs ใน scope ที่ review ครบ | reviewed / total × 100 |
