---
name: optimize-bandwidth
description: ปรับปรุง bandwidth ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง bandwidth ของ project ให้ดีขึ้น

## Scope

ใช้กับ bandwidth ใน project หรือ workspace ที่ต้องการปรับปรุง
