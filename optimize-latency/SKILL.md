...
description: ปรับปรุง latency ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง latency ของ project ให้ดีขึ้น

## Scope

ใช้กับ latency ใน project หรือ workspace ที่ต้องการปรับปรุง
