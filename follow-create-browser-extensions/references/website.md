...
Official resources for browser extension development
...
| Resource | URL |
|----------|-----|
| Chrome Web Store | https://chrome.google.com/webstore/dev |
...
| Discord Extensions Server | https://discord.gg/7ZFRDpD |
