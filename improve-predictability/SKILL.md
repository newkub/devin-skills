---
name: improve-predictability
description: ปรับปรุง predictability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง predictability ของ project ให้ดีขึ้น

## Scope

ใช้กับ predictability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- predictability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล