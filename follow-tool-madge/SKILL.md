...
3. ตรวจ official docs ล่าสุดก่อนใช้ API ที่ไม่แน่ใจ (tool madge)
...
- ใช้งาน library ถูกต้องตาม best practices (tool madge)
- ไม่มี security/performance pitfalls ที่รู้จัก (tool madge)
