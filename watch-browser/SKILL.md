...
เปิด browser และ navigate ไปยัง URL ที่ต้องการ watch ตาม `/follow-tool-agent-browser` ข้อ 2
...
Monitor อย่างต่อเนื่องและมีประสิทธิภาพ ดูคำสั่งเต็มที่ `/follow-tool-agent-browser` ข้อ 4
