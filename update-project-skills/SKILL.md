...
1. สำหรับแต่ละ skill ในรายการ:
   - ทำ `/update-devin-global-skills` เพื่อสร้างหรืออัปเดต skill package
...
4. ทำ `/deep-validate` สำหรับแต่ละ skill หลังสร้างเสร็จ
...
- ทุก skill ต้องเขียนตาม `/update-devin-global-skills`
...
- skills ที่จำเป็นถูกสร้างหรืออัปเดตตามมาตรฐาน `/update-devin-global-skills`
- ทุก skill ผ่าน `/deep-validate`
