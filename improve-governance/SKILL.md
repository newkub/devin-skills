...
description: ปรับปรุง governance ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง governance ของ project ให้ดีขึ้น

## Scope

ใช้กับ governance ใน project หรือ workspace ที่ต้องการปรับปรุง
