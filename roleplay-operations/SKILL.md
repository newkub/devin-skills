---
name: roleplay-operations
description: Roleplay operations personas — process, automation, release, compliance
...
ใช้เมื่อต้องการมุมมอง operations — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-operations <role>`
...
| Role | Focus | Subskill |
|------|-------|----------|
| process-analyst | documented processes, runbooks, SOPs, inefficiencies | `subskills/process-analyst/SKILL.md` |
| automation-specialist | CI/scripts coverage, manual toil, scheduled jobs | `subskills/automation-specialist/SKILL.md` |
| release-manager | versioning, changelog, pipeline, rollback → `/review-release` | `subskills/release-manager/SKILL.md` |
| compliance-specialist | audit trails, retention, consent, controls → `/review-compliance` | `subskills/compliance-specialist/SKILL.md` |
