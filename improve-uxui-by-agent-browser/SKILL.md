...
2. ทำ `/review-by-stakeholder` เพื่อขอ feedback — เลือก domain reference จาก `references/stakeholder-review.md` หรือไฟล์ที่เกี่ยวข้องให้ตรงกับหน้าที่ review
...
3. ใช้ `/report` เพื่อแสดงสรุป improvements ในรูปแบบตาราง
...
- ทุก reference ใน `references/` ถูกใช้งานตาม context
