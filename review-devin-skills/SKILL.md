---
name: review-devin-skills
description: ตรวจสอบ skill package แต่ละตัวก่อน update-devin-global-skills แก้ไข ครอบคลุม validation
---

## Goal

Review skill package แต่ละตัวใน devin skills repo ก่อนเรียก `update-devin-global-skills` เพื่อยืนยันว่าทุก skill ผ่านเกณฑ์มาตรฐาน: frontmatter, sections, line count, references, template selection

## Scope

ใช้ก่อนเรียก `update-devin-global-skills` — ตรวจ skill package แต่ละตัวตามมาตรฐาน `follow-write-devin-skills` ทำ review เท่านั้น ไม่แก้ไข skills ระหว่าง review ไม่ตรวจ cross-skill consistency (scope ของ `review-all-skills`)
...
- ถ้าต้องแก้ไข ให้เรียก `update-devin-global-skills` หลัง review
