...
ตอบในแชทเป็นตารางที่มี numbered columns, grouping, sorting เพื่อความชัดเจน โดยยังไม่ดำเนินการใดๆ
...
5. ถ้าเป็นรายงานสถานะ → อ้างอิง `/report-agents-session-status`
