...
ตอบในแชทเป้นตารางที่มี numbered columns, grouping, sorting เพื่อความชัดเจน โดยยังไม่ดำเนินการใดๆ
...
4. ถ้าเป้นรายงานความคืบหน้า → อ้างอิง `/report-ansi`
5. ถ้าเป้นรายงานสถานะ → อ้างอิง `/report-agents-session-status`
...
2. ทุกตารางต้องมี numbered column
...
1. ตรวจสอบว่าทุกตารางมี numbered column
