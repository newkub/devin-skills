...
(merged from: follow-layered-architecture)
...
- ถ้า project ต้องการ modular boundaries → ใช้ module structure ใน `src/modules/<feature>/` ตาม `references/patterns-clean-architecture.md`
