...
(merged from: follow-nextjs-architecture)

จัดโครงสร้างโปรเจกต์ Next.js ตาม best practices พร้อม App Router patterns, modules/ และ monorepo support — สำหรับ Next.js projects ที่ใช้ App Router และ Server/Client Components ทั้ง standalone และ monorepo
...
- ถ้า module ใหญ่เกินไป → ทำ `/refactor-workspace`
