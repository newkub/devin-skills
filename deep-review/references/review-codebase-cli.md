...
ถ้า CLI error ให้ทำ `/deep-review` Step 3.5 แล้วดู `deep-review/references/cli-review-steps.md` ขั้นตอน 3-7 เพื่อแก้ไขแล้วรันใหม่

## Metric Triggers สำหรับ Update CLI

ถ้า metrics ตรงเงื่อนไขข้างล่าง → ทำ `/update-create-analyze-cli` เพื่อแก้ไข analyzer ก่อน แล้วทำ `/deep-review` Step 3.5 ดู `deep-review/references/cli-review-steps.md` ขั้นตอน 3-7 เพื่อ integrate แล้วรัน review ใหม่ (ไม่เกิน 3 รอบ):
...
ถ้าไฟล์เหล่านี้ไม่อยู่ → ทำ `/deep-review` Step 3.5 เพื่อสร้าง
