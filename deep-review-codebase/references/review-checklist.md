...
ตรวจสอบ `tools/review-codebase` CLI ก่อนเรียก `/deep-review-codebase` เพื่อยืนยันว่า Clean Architecture, analyzer structure, category coverage, CLI interface, และ workspace integration ครบถ้วนและถูกต้อง
...
3. ตรวจว่าทุก analyzer มี `reviewWorkflow` map ไปยัง `/deep-review-codebase` หรือ references
...
- ถ้าต้องแก้ไข ให้เรียก `/deep-review-codebase` หลัง review
...
- Score < 70 → แนะนำให้เรียก `/deep-review-codebase` ก่อนดำเนินการ
