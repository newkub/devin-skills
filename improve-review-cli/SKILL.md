...
2. ทำ `/create-skills-from-manifest` เพื่อสร้าง skills ที่ขาดจาก dependencies และ features
...
1. ทำ `/create-skills-from-manifest` เพื่อสร้าง skills ที่ขาดจาก dependencies
