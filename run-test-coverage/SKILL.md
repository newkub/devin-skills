...
ทำ `/run-test` เพื่อตรวจสอบ test framework ที่ใช้ และบรรลุ 100% coverage ทุกประเภท
...
6. ถ้า coverage ไม่ถึง 100% → ทำ `/review-test` วิเคราะห์ gaps เติม tests ทีขาด
