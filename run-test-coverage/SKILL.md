...
5. หาก coverage ไม่ถึง 100% ทำ `/improve-test-coverage` เพื่อวิเคราะห์ gaps และเขียน tests ที่ขาด
...
- หาก coverage ไม่ถึง 100% ต้องทำ `/improve-test-coverage` เพื่อวิเคราะห์ gaps และเขียน tests ที่ขาด
...
- หากไม่ถึง 100% ทำ `/improve-test-coverage` เพื่อวิเคราะห์ gaps และเขียน tests ที่ขาด
