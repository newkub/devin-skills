...
description: ปรับปรุง modularity ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง modularity ของ project ให้ดีขึ้น

## Scope

ใช้กับ modularity ใน project หรือ workspace ที่ต้องการปรับปรุง
