...
ใช้กับ code, services, workflows ที่มี findings ด้าน error handling, recovery, monitoring, logging, alerting, debuggability — ไม่รวม business logic หรือ performance (ใช้ `/review-business`, `/optimize-*` แทน)
