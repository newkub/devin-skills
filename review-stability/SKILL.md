...
ไม่รวมการ fix (ใช้ `/update-review-cli-and-run` สำหรับ fix)
...
2. ทำ `/update-review-cli-and-run` — เรียก `/update-rules` ภายในตัวเองเพื่ออัปเดต ast-grep rules
3. ถ้า `/update-review-cli-and-run` ข้าม `/update-rules` → ทำ `/update-rules` แยก
...
2. ถ้าพบ performance issues ให้ทำ `/update-review-cli-and-run`
3. ถ้าพบ concurrency issues ให้ทำ `/update-review-cli-and-run`
4. ถ้าพบ security issues ให้ทำ `/update-review-cli-and-run`
...
- ไม่ซ้ำกับ `/update-review-cli-and-run` ใช้ workflows เหล่านั้นแทนการเขียนซ้ำ
