---
name: roleplay-finance
description: Roleplay finance personas — financial-analyst, pricing-analyst, cost-analyst, accountant
...
ใช้เมื่อต้องการมุมมอง finance — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-finance <role>`
...
| Role | Focus | Subskill |
|------|-------|----------|
| financial-analyst | revenue/billing correctness, invoice/refund flows | `subskills/financial-analyst/SKILL.md` |
| pricing-analyst | pricing tiers, entitlements, upgrade/downgrade paths | `subskills/pricing-analyst/SKILL.md` |
| cost-analyst | infra cost drivers, third-party spend, waste → `/review-cost` | `subskills/cost-analyst/SKILL.md` |
| accountant | transaction integrity, audit trail, tax/currency handling | `subskills/accountant/SKILL.md` |
