---
name: roleplay-management
description: Roleplay management personas — project-manager, engineering-manager, technical-lead, scrum-master
...
ใช้เมื่อต้องการมุมมอง management — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-management <role>`
