...
ถ้าต้องการรัน cloud verify หรือ ship บน cloud ให้ใช้ `/run-verify-cloud` หรือ `/ship-cloud` แทน
...
- ถ้าต้องการรัน pipeline ให้ใช้ `/run-verify-cloud` หรือ `/ship-cloud`
