...
2. ทำ `/deep-review-codebase` เพื่อตรวจ naming และ structure
...
1. ทำ `/deep-review-codebase` เพื่อวิเคราะห์ coverage gaps และบรรลุ 100%
...
- Coverage verification และ 100% enforcement อยู่ใน `/deep-review-codebase` และ `/run-test-coverage`
...
- Coverage 100% ผ่าน `/deep-review-codebase` และ `/run-test-coverage`
