...
- ไม่ซ้ำกับ `/review-backend`, `/review-code-quality` — ถ้าพบ issues ในหมวดนั้น ให้ส่งต่อไปยัง review workflow นั้น
...
- ไม่ซ้ำกับ `/review-backend` สำหรับ race condition, deadlock, parallel execution
- ไม่ซ้ำกับ `/review-backend` สำหรับ error boundaries, error messages, graceful degradation
- ไม่ซ้ำกับ `/review-code-quality` สำหรับ type design, hardcode, naming, readability
- ถ้าพบ issues ในหมวดเหล่านั้น ให้ส่งต่อไปยัง `/review-code-quality`
