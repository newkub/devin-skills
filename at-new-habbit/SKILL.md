...
แก้ไข files ใน project `D:\saas\new-habbit` อย่างปลอดภัย มีขอบเขตชัดเจน และ validate
...
1. ตรวจสอบ `project-root: D:\saas\new-habbit`
2. ใช้ `workdir = D:\saas\new-habbit` สำหรับทุก command
