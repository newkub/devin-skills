...
2. ทำ `/review-techstack` เพื่อ review tech stack, dependencies, และ library design (create mobile ios)
...
- ใช้ /follow-create-mobile-cross-capacitor ถ้าจำเป็น (create mobile ios)
