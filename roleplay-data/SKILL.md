---
name: roleplay-data
description: Roleplay data personas — analyst, scientist, ml-engineer, ai-engineer
...
ใช้เมื่อต้องการมุมมอง data — ส่งต่อจาก `/roleplay-by-all-stakeholder` หรือเรียกตรงด้วย `/roleplay-data <role>`
...
| Role | Focus | Subskill |
|------|-------|----------|
| data-analyst | metrics/dashboards, event tracking, reporting models, export | `subskills/data-analyst/SKILL.md` |
| data-scientist | data quality, features, notebooks, reproducibility | `subskills/data-scientist/SKILL.md` |
| ml-engineer | model serving, versioning, monitoring, pipelines → `/review-ai` | `subskills/ml-engineer/SKILL.md` |
| ai-engineer | prompts, evals, guardrails, token cost → `/review-ai` | `subskills/ai-engineer/SKILL.md` |
