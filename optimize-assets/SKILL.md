...
description: ปรับปรุง assets ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง assets ของ project ให้ดีขึ้น

## Scope

ใช้กับ assets ใน project หรือ workspace ที่ต้องการปรับปรุง
