---
name: improve-ci-cd
description: ปรับปรุง ci-cd ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง ci-cd ของ project ให้ดีขึ้น

## Scope

ใช้กับ ci-cd ใน project หรือ workspace ที่ต้องการปรับปรุง
