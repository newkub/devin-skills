# Deep Test — Integration Domain

รัน integration tests สำหรับทดสอบการทำงานร่วมกันของ modules, data flow, และ integration points — ไม่รวม unit tests หรือ E2E tests
