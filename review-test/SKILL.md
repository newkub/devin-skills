...
ใช้สำหรับ test review ในทุก workspace — ครอบคลุม unit tests, integration tests, E2E tests, test fixtures, mocking, coverage analysis — ไม่รวม code quality review (อยู่ใน `/review-code-quality`)
...
### 4. Scope
- ไม่ review production code quality — อยู่ใน `/review-code-quality`
