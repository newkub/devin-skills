...
4. ถ้าต้องการ execute การเปลี่ยนแปลงจริง ให้ส่งต่อไปยัง `/review-codebase-everythink`

## Rules

- ตอบแค่ deps ที่ควรใช้ ไม่ execute การเปลี่ยนแปลง package ใด ๆ
- ถ้าพบ unused, duplicate, security issues ให้ reference ไป `/review-codebase-everythink`
- ใช้ scoring system ชัดเจน (1-35 points)
- เปรียบเทียบ apples-to-apples กับ version ล่าสุด
- ไม่ต้องเขียน migration plan ละเอียด (ให้ `/review-codebase-everythink` ทำ)
