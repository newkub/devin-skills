...
description: ปรับปรุง network ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง network ของ project ให้ดีขึ้น

## Scope

ใช้กับ network ใน project หรือ workspace ที่ต้องการปรับปรุง
