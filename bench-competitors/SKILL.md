...
1. ทำ `/update-review-cli-and-run` สำหรับ performance
2. ทำ `/update-review-cli-and-run` สำหรับ UX/UI
...
2. ทำ `/update-review-cli-and-run` สำหรับ performance improvements
3. ทำ `/update-review-cli-and-run` สำหรับ UX/UI improvements
