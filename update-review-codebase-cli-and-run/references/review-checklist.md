...
ตรวจสอบ `tools/review-codebase` CLI ก่อนเรียก `/update-review-codebase-cli-and-run` เพื่อยืนยันว่า Clean Architecture, analyzer structure, category coverage, CLI interface, และ workspace integration ครบถ้วนและถูกต้อง
...
3. ตรวจว่าทุก analyzer มี `reviewWorkflow` map ไปยัง `/update-review-codebase-cli-and-run` หรือ references
...
- ถ้าต้องแก้ไข ให้เรียก `/update-review-codebase-cli-and-run` หลัง review
...
- Score < 70 → แนะนำให้เรียก `/update-review-codebase-cli-and-run` ก่อนดำเนินการ
