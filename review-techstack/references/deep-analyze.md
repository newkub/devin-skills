...
2. ทำ `/deep-review-codebase` เพื่อให้ analyzers ครอบคลุม categories ล่าสุด
...
10. ถ้า review CLI ไม่ผ่าน → ทำ `/deep-review-codebase` แล้ว re-run ถ้าไม่ผ่านหลังจาก 3 ครั้ง → stop และ report

## Expected Outcome

- ผลจาก `/deep-analyze`, `/deep-review-codebase`, `/run-review`
