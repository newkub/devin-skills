...
2. ทำ `/review-codebase-everything` เพื่อให้ analyzers ครอบคลุม categories ล่าสุด
...
10. ถ้า review CLI ไม่ผ่าน → ทำ `/review-codebase-everything` แล้ว re-run ถ้าไม่ผ่านหลังจาก 3 ครั้ง → stop และ report

## Expected Outcome

- ผลจาก `/deep-analyze`, `/review-codebase-everything`, `/run-review`
