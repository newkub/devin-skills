...
1. ตรวจสอบ version ปัจจุบันเทียบกับ latest stable ด้วย `/update-version-to-latest` (dry run)
2. ตรวจสอบ runtime versions ด้วย `/update-version-to-latest` (dry run)
3. ถ้าต้องการ update ทุก version รวมกัน ให้ใช้ `/update-version-to-latest` (dry run)
