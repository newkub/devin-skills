---
name: at-learn-wrikka-com
project-root: D:/newkub/products/learn-wrikka-com
description: แก้ไข files ใน project learn-wrikka-com
---

## Goal

แก้ไข files ใน project `D:/newkub/products/learn-wrikka-com` อย่างปลอดภัย มีขอบเขตชัดเจน และ validate

## Scope

ใช้เมื่องานต้องแก้ไข source code, config, docs ใน `learn-wrikka-com`
...
1. ตรวจสอบ `project-root: D:/newkub/products/learn-wrikka-com`
2. ใช้ `workdir = D:/newkub/products/learn-wrikka-com` สำหรับทุก command
...
- ใช้ `workdir = D:/newkub/products/learn-wrikka-com` เสมอ
