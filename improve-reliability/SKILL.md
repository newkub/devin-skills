...
description: ปรับปรุง reliability ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง reliability ของ project ให้ดีขึ้น

## Scope

ใช้กับ reliability ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- reliability ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล