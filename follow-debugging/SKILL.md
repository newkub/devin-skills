...
2. ทำ `/update-review-cli-and-run` ถ้าพบว่า debug ยากเพราะ logging ไม่พอ
...
- รายละเอียดเพิ่มเติมอยู่ใน `/update-review-cli-and-run`
...
- รายละเอียด improving debuggability อยู่ใน `/update-review-cli-and-run` แล้ว
