...
ถ้า CLI error ให้ทำ `update-review-cli-and-run` Step 3-7 เพื่อแก้ไขแล้วรันใหม่

## Metric Triggers สำหรับ Update CLI

ถ้า metrics ตรงเงื่อนไขข้างล่าง → ทำ `/update-create-analyze-cli` เพื่อแก้ไข analyzer ก่อน แล้วทำ `update-review-cli-and-run` Step 3-7 เพื่อ integrate แล้วรัน review ใหม่ (ไม่เกิน 3 รอบ):
...
ถ้าไฟล์เหล่านี้ไม่อยู่ → ทำ `update-review-cli-and-run` เพื่อสร้าง
