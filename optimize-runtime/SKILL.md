...
description: ปรับปรุง runtime ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง runtime ของ project ให้ดีขึ้น

## Scope

ใช้กับ runtime ใน project หรือ workspace ที่ต้องการปรับปรุง
