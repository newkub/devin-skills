---
name: review-lib
description: Review library design, API surface, bundle size, tree-shaking, peer deps, semver, compatibility, documentation, export strategy
---
...
5. Critical: dual package hazard, missing TypeScript declarations, broken export, circular export, export ที่ไม่มี implementation
6. High: over-exported API, missing barrel export, inconsistent export naming, missing export conditions, missing declaration map
...
7. Critical: missing peer deps declaration, dual package hazard, broken tree-shaking, bundle size ที่ใหญ่เกินไป, missing sideEffects field
8. High: missing semver compliance, missing compatibility matrix, over-sized bundle, missing deprecation policy, missing files field, incorrect publishConfig
