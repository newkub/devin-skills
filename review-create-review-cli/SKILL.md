...
> ดู `references/clean-architecture.md` สำหรับ architecture validation rules
...
> ดู `references/analyzers.md` สำหรับ analyzer structure และ coverage rules
...
3. ตรวจว่าทุก analyzer มี `reviewWorkflow` map ไปยัง `/review-codebase` หรือ references
...
> ดู `references/cli-interface.md` สำหรับ CLI interface และ output format rules
...
> ดู `references/analyze-integration.md` สำหรับ integration validation rules
...
> ดู `references/package-scripts.md` สำหรับ package scripts validation rules
