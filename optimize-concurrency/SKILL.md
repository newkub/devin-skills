...
description: ปรับปรุง concurrency ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง concurrency ของ project ให้ดีขึ้น

## Scope

ใช้กับ concurrency ใน project หรือ workspace ที่ต้องการปรับปรุง
...
## Expected Outcome
- concurrency ดีขึ้นตาม criteria
- ไม่มี regression
- รายงานสรุปผล