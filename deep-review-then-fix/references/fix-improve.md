...
4. ถ้าเป้าหมายเป็น docs → ทำ `/review-docs`, `/review-docs`
...
4. ถ้า gaps เยอะ → ทำ `/create-plan-in-dot-devin` เพื่อวางแผน
...
- ถ้ามี performance, complexity, cost, uncertainty, invariants หรือ metrics → ใช้ `/follow-math-concepts`
