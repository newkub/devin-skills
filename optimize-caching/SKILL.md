...
description: ปรับปรุง caching ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง caching ของ project ให้ดีขึ้น

## Scope

ใช้กับ caching ใน project หรือ workspace ที่ต้องการปรับปรุง
