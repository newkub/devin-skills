---
name: optimize-cost
description: ปรับปรุง cost ของ project
allowed-tools:
  - read
  - edit
  - grep
...
ปรับปรุง cost ของ project ให้ดีขึ้น

## Scope

ใช้กับ cost ใน project หรือ workspace ที่ต้องการปรับปรุง
