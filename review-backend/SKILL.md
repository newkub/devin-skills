...
3. ทำ `/update-review-cli-and-run` — `/update-review-cli-and-run` เรียก `/update-rules` ภายในเพื่ออัปเดต ast-grep rules
4. ถ้า `/update-review-cli-and-run` ข้าม `/update-rules` → ทำ `/update-rules` แยก
...
1. ทำ `/update-review-cli-and-run` สำหรับ API review (อ้างอิง `references/api.md`)
2. ทำ `/update-review-cli-and-run` สำหรับ service layer review (อ้างอิง `references/service.md`)
3. ทำ `/update-review-cli-and-run` สำหรับ database review (อ้างอิง `references/database.md`)
4. ทำ `/update-review-cli-and-run` สำหรับ data flow review (อ้างอิง `references/data-flow.md`)
5. ทำ `/update-review-cli-and-run` สำหรับ data fetching review (อ้างอิง `references/data-fetching.md`)
6. ทำ `/update-review-cli-and-run` สำหรับ data validation review (อ้างอิง `references/data-validation.md`)
7. ทำ `/update-review-cli-and-run` สำหรับ integration review (อ้างอิง `references/integration.md`)
...
- ทำ `/update-review-cli-and-run` ก่อนรัน sub-reviews เสมอ — `/update-review-cli-and-run` เรียก `/update-rules` ภายใน
- ถ้า `/update-review-cli-and-run` ข้าม `/update-rules` → ทำ `/update-rules` แยก
