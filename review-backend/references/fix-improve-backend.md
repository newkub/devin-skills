...
ใช้กับ backend services, APIs, database layers, workers, queues — ไม่รวม frontend หรือ business domain เฉพาะ (ใช้ `/review-frontend`, `/review-business` แทน)
...
1. ทำ `/review-api` สำหรับ API findings
...
1. ทำ `/review-database` สำหรับ schema/query issues
...
1. ทำ `/review-security` สำหรับ vulnerabilities
2. ทำ `/review-stability` สำหรับ error handling/recovery
