...
## Scope
- สำหรับ skills ที่เกี่ยวข้อง: `list-cloudflare-projects`, `list-cloudflare-worker-fail`, `open-all-cloudflare-projects`, `watch-cicd-and-resolve`, `follow-service-cloudflare`
