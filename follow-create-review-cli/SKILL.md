...
> ดู [references/analyzers.md](references/analyzers.md) สำหรับ analyzer structure และ coverage rules
...
> ดู [references/cli-interface.md](references/cli-interface.md) สำหรับ CLI interface และ output format rules
