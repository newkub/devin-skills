...
- ถ้าต้องการวาด flow ช่วย visualize ให้ทำ `/report-ansi`
- ถ้าต้องการ scan จริงด้วย scripts ให้ใช้ `/review-codebase-everythink`
- ถ้าต้องการ review cross-domain impact ให้ใช้ `/review-codebase-everythink`
