...
- ระบุ target, dimensions (architecture, performance, security, maintainability), criteria. ถ้า target ไม่ชัด → ทำ `/ask-me`. ทำ `/deep-research`, `/learn-web`, `/check-reference`. ถ้าข้อมูลไม่พอ → ระบุความไม่แน่นอน
