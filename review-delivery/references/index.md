# review-delivery References Index

| File | Responsibility |
|---|---|
| [ci-cd-setup.md](ci-cd-setup.md) | CI/CD Setup And Review |
| [ci-cd.md](ci-cd.md) | CI/CD Pipeline Checks |
| [config-setup.md](config-setup.md) | Config Setup And Review |
| [config.md](config.md) | Config Health Checks |
| [containerization.md](containerization.md) | Containerization Setup And Review |
